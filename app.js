...
// function: How to insert data into a array, 
// function: how to create a object
// function: how to insert that object into an array
// 
...
function addingTwoNums(leftNumber, rightNumber) {
    console.log(`${leftNumber} + ${rightNumber} = ${leftNumber + rightNumber}`)
}
...
addingTwoNums(5, 5);
addingTwoNums(23, 43);
addingTwoNums(foo, bar);




function calculateArea(width, height) {
    //if you need the answer to out of a function
    //RETURN it
...
let areaAnswerOne = calculateArea(12, 3); //36
let areaAnswerTwo = calculateArea(4, 11); //44
console.log(areaAnswerOne);
...
whichNumberIsHigher(areaAnswerOne, areaAnswerTwo)
